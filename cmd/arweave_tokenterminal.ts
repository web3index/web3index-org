/**
 * @file This script retrieves Arweave transaction fee via the TokenTerminal API. This
 * requires a paid TokenTerminal API subscription which is expensive for personal use.
 * As a result we are keeping this script disabled for now. If you have a better
