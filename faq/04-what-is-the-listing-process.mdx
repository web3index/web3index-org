...
- Reviews and voting periods are coordinated by Discord informally initially. The index uses a majority rule and each project's representative gets one vote.
...
- If you're interested in getting a project listed, check out the [README](https://github.com/web3index/web3index-org#providing-revenue-data-for-project-submission) for instructions, or get in touch via [Discord](https://discord.gg/HrgU5ZtD).
