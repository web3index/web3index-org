...
The Web3 Index is designed to help you see past the hype around Web3 and identify the protocols generating real revenue for doing real work. Drawing on open-source data, it ranks protocols based on the fees they are generating for providing services.
