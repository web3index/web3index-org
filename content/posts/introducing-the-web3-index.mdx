...
abstract: Today, I'm excited to introduce The Web3 Index, an open source index that tracks fees being paid into Web3 networks.
author: Adam Soffer
...
Unlike most indexes in DeFi (a category of Web3) that weight listings based market capitalization or "total locked value (TLV)", The Web3 Index uses a fundamental index methodology. A key belief behind the fundamental index methodology is that underlying valuation figures (i.e. network revenue and usage) are more accurate estimators of a network's intrinsic value, rather than the listed market value of the network's token.
...
To get started contributing today, follow [these instructions](https://github.com/web3index/web3index-org/blob/main/README.md#project-integration-instructions).
