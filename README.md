...
Once you've successfully provided added a project othe subgraph, make sure to add the project to the [registry file](./registry.json) using its protocol id on the subgraph as the key.
